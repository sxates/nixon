...
When **reviewing recordings** in Nixon, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Nixon records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Nixon recordings** - Use wired/speakers instead
...
### This is Not a Nixon Bug

The issue is in **macOS's Bluetooth audio stack**, not in Nixon's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Nixon bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Nixon shows a warning when Bluetooth headphones are active during playback.
