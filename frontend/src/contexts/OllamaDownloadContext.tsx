...
export function OllamaDownloadProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Wrap each resolved unlisten (once-guarded + crash-proof); if the effect was
    // already cleaned up before this listener resolved, tear it down now.
