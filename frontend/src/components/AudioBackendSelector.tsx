...
export function AudioBackendSelector({
  ...
  return (
    <div className="space-y-2">
      ...
      {error && (
        <div className="p-2 text-xs text-foreground bg-destructive/10 border border-destructive/30 rounded-md">
          {error}
        </div>
      )}
          ...
          return (
            ...
            >
              <input
                ...
                disabled={isDisabled}
                className="mt-1 h-4 w-4 text-brand focus:ring-ring border-input"
              />
