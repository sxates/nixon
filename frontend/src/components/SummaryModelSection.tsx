...
/**
 * The summary model row (specs/0067).
 *
 * Its own component so the Summary tab can put it LAST: it is the one setting on that tab
 * nobody should need to touch — Nixon picks it from the machine's RAM — so it sits under
 * the things people do change rather than leading with a decision already made for them.
 */
...
export function SummaryModelSection({ refetchTrigger }: SummaryModelSectionProps) {
