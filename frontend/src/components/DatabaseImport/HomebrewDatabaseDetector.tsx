...
export function HomebrewDatabaseDetector({ onImportSuccess: _onImportSuccess, onDecline }: HomebrewDatabaseDetectorProps) {
  ...
  return (
    <div className="mb-4 p-4 bg-muted border-2 border-border rounded-lg">
      <div className="flex items-start gap-3">
        <Database className="h-6 w-6 text-brand mt-0.5 flex-shrink-0" />
        <div className="flex-1">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-success text-success-foreground rounded-lg hover:bg-success/90 disabled:bg-muted disabled:text-muted-foreground disabled:cursor-not-allowed transition-colors"
            >
              {isImporting ? (
                <>
            ...
            <button
              onClick={handleNo}
              disabled={isImporting}
              className="flex-1 px-4 py-2 border-2 border-brand text-brand rounded-lg hover:bg-brand/10 disabled:bg-muted disabled:cursor-not-allowed transition-colors"
            >
              No, Browse Manually
            </button>
          </div>
