  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-[600px]" onPointerDownOutside={(e) => e.preventDefault()}>
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to Nixon!</DialogTitle>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-brand text-brand-foreground rounded-lg hover:bg-brand/90 disabled:bg-muted disabled:text-muted-foreground disabled:cursor-not-allowed transition-colors"
            >
            ...
            <div className="p-3 bg-success/10 border border-success/30 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground mt-1 break-all">{detectedPath}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="flex flex-col gap-3 pt-2">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full px-4 py-3 border-2 border-input text-foreground rounded-lg hover:bg-muted disabled:bg-muted disabled:cursor-not-allowed transition-colors"
            >
